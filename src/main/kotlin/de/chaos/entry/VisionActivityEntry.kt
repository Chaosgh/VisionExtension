...
class VisionActivityEntry(
    ...
    @Help("Forced yaw (degrees, 0-360)") override val forcedLookYaw: Float = VisionDefaults.FORCED_LOOK_YAW,
    @Help("Forced pitch (degrees, -90 to 90)") override val forcedLookPitch: Float = VisionDefaults.FORCED_LOOK_PITCH,
